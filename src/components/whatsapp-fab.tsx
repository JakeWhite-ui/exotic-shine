...
export function WhatsAppFab({ locale }: { locale: Locale }) {
  return (
    <a
      ...
      aria-label={t(ui.cta.whatsapp, locale)}
      className="fixed bottom-5 end-5 z-40 flex size-14 items-center justify-center rounded-full bg-[#25D366] text-black shadow-lg transition-transform hover:scale-105"
    >
      <svg
        aria-hidden
        viewBox="0 0 24 24"
