...
export const ui = {
  ...
  cta: {
    ...
    // Shorter than `quote` on purpose: this one repeats on every service card,
    // where a full-width "Get a free quote" would shout over the service name.
    quoteShort: { en: "Get a quote", ar: "اطلب عرض سعر" },
  ...
  labels: {
    ...
    playClip: { en: "Play this clip", ar: "تشغيل المقطع" },
    pauseClip: { en: "Pause this clip", ar: "إيقاف المقطع" },
  },
  sections: {
    ...
    clipsTitle: { en: "Cars going through the unit", ar: "سيارات داخل الورشة" },
    clipsLede: {
      en: "Filmed on our own floor in Ras Al Khor. No stock footage and no renders — just the cars that come through the unit.",
      ar: "مصوّرة داخل ورشتنا في رأس الخور. لا صور جاهزة ولا تصاميم — فقط السيارات التي تمر من عندنا.",
    },
